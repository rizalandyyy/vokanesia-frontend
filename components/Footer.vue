            ...
            <div class="single-footer-widget">
              ...
              <ul class="footer-contact-info">
                ...
                <li>
                  ...
                  ><a
                    href="https://templates.envytheme.com/cdn-cgi/l/email-protection#deb6bbb2b2b19ebab7bcb7a4f0bdb1b3"
                    ><span
                      class="__cf_email__"
                      data-cfemail="97fff2fbfbf8d7f3fef5feedb9f4f8fa"
        ...
        <div class="footer-bottom-area">
          <div class="row align-items-center">
            <div class="col-lg-6 col-md-6">
              <p>
                <i class="bx bx-copyright"></i>2021 <strong>Dibiz</strong> is
                Proudly Powered by
